...
export function middleware(request: NextRequest) {
    ...
    response.headers.set(
        ...
        "default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval'; style-src 'self' 'unsafe-inline'; img-src 'self' data: blob: https:; font-src 'self' https://fonts.gstatic.com; connect-src 'self' https://*.supabase.co https://api.telegram.org; frame-src 'self'; object-src 'none'; base-uri 'self';"
    );
