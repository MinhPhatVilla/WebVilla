                ...
                <header className="relative z-50 bg-white/95 backdrop-blur-md border-b border-gray-100 shadow-sm">
                    <div className="max-w-7xl mx-auto px-4 h-16 flex items-center justify-between">
                        ...
                        <div className="hidden md:flex items-center gap-3">
                            <a href="tel:0333160365" className="flex items-center gap-2 text-gray-600 hover:text-blue-600 transition-colors text-sm">
                                <Phone size={16} />
                                <span className="font-semibold">0333.160.365</span>
                            </a>

                            {user ? (
                                /* 👤 Đã đăng nhập — Dropdown menu đầy đủ */
                                <div className="relative">
                                    <button
                                        onClick={() => setShowUserMenu(!showUserMenu)}
                                        className="flex items-center gap-2 bg-gray-100 hover:bg-gray-200 px-3 py-2 rounded-full transition-all"
                                    >
                                ...
                                <>
                                    <Link
                                        href="/login"
                                        className="flex items-center gap-1.5 text-gray-600 hover:text-blue-600 transition-colors text-sm font-semibold px-3 py-2 rounded-full hover:bg-gray-100"
                                    >
                                        <LogIn size={16} />
                                        Đăng nhập
                                    </Link>
                                    <Link
                                        href="/register"
                                        className="bg-gradient-to-r from-cyan-500 to-blue-600 text-white px-4 py-2 rounded-full text-xs font-bold shadow-lg hover:shadow-xl hover:scale-105 transition-all flex items-center gap-1.5"
                                    >
                                        <UserCircle size={14} />
                                        Đăng ký
                                    </Link>
